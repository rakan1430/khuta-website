...
/* ============================================================
   ...
   ------------------------------------------------------------
   كان في js/13-school.js حين كان آخر ملف، ونُقل هنا لأن هذا صار الأخير.
   السبب نفسه: أي حدث دخول يصل قبل اكتمال كل التعريفات يُحفظ في طابور ولا
   يُعالَج إلا بعد اكتمالها. لو صُرف قبلها لارتفع خطأ "دالة غير معرَّفة"
   وسقطت معالجة الدخول — وهو خلل وقع فعلاً في الإنتاج بعد تقسيم app.js.
