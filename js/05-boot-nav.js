/* ============================================================
   ...
   ============================================================ */
window.onload = () => {
    /* ⚠️ النوافذ المنبثقة تُنقل لتكون ابناً مباشراً لـbody. بعضها مكتوب داخل
       ‎.main-content‎ (إرسال الاختبار، نتائجه، إسناد الفصل)، وتلك حاويةٌ لها
       z-index:1 فتُنشئ سياق تكديس يحبس النافذة تحتها مهما علا رقمها — فكان شريط
       «دخول سريع» (z-index:60 في body) يغطّي رأس النافذة على الجوّال: عنوان
       النتائج ونصّها وأزرار «فصول/مراحل/طلاب». التقطه الفحص البصري الشامل. */
    try{
        document.querySelectorAll(".main-content .overlay-screen").forEach(el => document.body.appendChild(el));
    }catch(e){ /* لا يجوز أن يُسقط الإقلاع */ }
