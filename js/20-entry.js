/* ============================================================
   مدخل المعلّم، والدخول السريع، وحدوده
   ------------------------------------------------------------
   منصة واحدة لا اثنتان. خُطى تبقى كما هي لكل مستخدميها، وأقسام المدرسة لا
   تظهر إلا لمن أضافته الإدارة — بالعضوية لا بالعنوان.

     • الطالب  → الموقع العادي بحساب Google، فتظهر أقسامه بالعضوية.
     • المعلّم → ‎?apply=teacher يفتح نموذج الطلب على دور "معلّم" مباشرة.
     • الإدارة → الموقع العادي أيضاً. لا رابط خاص.

   ⚠️ حُذف "رابط الإدارة المشفَّر" الذي كان هنا، ولثلاثة أسباب:
   (١) لم يكن يعمل أصلاً. كان يُظهر صندوقاً داخل شاشة الدخول، وشاشة الدخول
       تُخفى تلقائياً لمن له جلسة قائمة — فمن فتحه وهو مسجَّل رأى الشاشة
       تومض وتختفي. وهذا ما وصفه المالك بـ"يفتح ويغلق على طول".
   (٢) ولا لزوم له: الإداري يدخل من الموقع العادي بحساب Google، فيظهر له
       قسم "إدارة المدرسة" بعضويته تلقائياً — وهو ما جرّبه المالك ونجح.
   (٣) وخفاء الرابط لم يكن حمايةً بحدّ ذاته في أي حال: من رآه مرة حفظه،
       والحماية الحقيقية في صلاحيات قاعدة البيانات لا في سرّية عنوان.
   ============================================================ */
