...
"school.roleAdmin":"إدارة","school.bulkMove":"نقل","school.bulkAdd":"إسناد إضافي",
"school.bulkClear":"إلغاء التحديد","school.selectAll":"تحديد كل الطلاب المعروضين",
"school.classesTitle":"الفصول",
"school.classesSub":"أنشئ فصول المدرسة أولاً. بدونها لا يعمل الجدول الدراسي، ولا يرى الطالب ملفات معلّميه، ولا يجد المعلّم فصلاً يرسل له اختباراً.",
"school.classGrade":"المرحلة","school.classSection":"الشعبة (إجبارية)",
"school.classNameOpt":"اسم الفصل (اختياري)","school.classAdd":"إضافة فصل",
"school.assignTitle":"إسناد إلى فصل","school.assignPick":"الفصل",
"school.assignSubject":"المادة (للمعلّم)","school.assignAdd":"إسناد",
"school.assignCurrent":"الفصول المسنَدة حالياً","school.assignBtn":"الفصول",
"school.reqNeedSignin":"سجّل دخولك بحساب Google أولاً",
"school.reqNeedSigninWhy":"نأخذ بريدك من حسابك مباشرةً، فتصل موافقة الإدارة إليك بلا خطأ في الكتابة.",
"school.reqEmail":"بريدك (من حسابك — لا يُعدَّل)",
"school.reqEmailNote":"على هذا البريد تُنشئ الإدارة حسابك، فتأكد أنه الحساب الذي ستستعمله.",
"school.limitedBar":"دخول سريع: العرض متاح. الحذف وإرسال الاختبارات وتعديل الجدول تحتاج تأكيد هويتك.",
"school.confirmGoogle":"تأكيد بحساب Google",
"school.quickTitle":"الدخول السريع على السبورة",
"school.quickSub":"اضبط كلمة مرور لحسابك نفسه لتدخل بها بسرعة على سبورة الفصل بدل كتابة بيانات Google كل حصة.",
"school.quickWarnTitle":"ما الذي يتيحه هذا الدخول؟",
"school.quickWarnBody":"العرض فقط: الملفات والروابط والجدول والاختبارات. أما حذف ملف أو رابط، أو إرسال اختبار، أو تعديل الجدول — فتبقى محتاجة تأكيد هويتك بحساب Google. والسبب أن كلمة المرور تُكتب على شاشة يراها الصف كله، فقد يلتقطها طالب.",
"school.quickPass":"كلمة المرور الجديدة",
"school.quickPass2":"تأكيدها",
"school.quickSave":"حفظ كلمة المرور",
"school.examDuration":"المدة بالدقائق (اختياري)",
"school.examQuestions":"الأسئلة",
"school.examAddQ":"أضف سؤالاً",
"school.examImport":"استيراد سريع بلصق نصّي",
"school.examImportBtn":"أضِف للمسودّة",
"school.sendTitle":"إرسال الاختبار",
"school.sendSub":"اختر فصولاً أو مراحل أو طلاباً بأعيانهم. يمكنك الجمع بينها.",
"school.sendClasses":"فصول","school.sendGrades":"مراحل","school.sendStudents":"طلاب",
"school.sendNow":"إرسال",
"school.dueLabel":"موعد التسليم (اختياري)",
"school.dueHint":"اتركه فارغاً لواجب بلا موعد. وهو الموعد الذي تُكشف بعده الإجابات الصحيحة.",
"school.revealLabel":"متى يرى الطالب الإجابات الصحيحة؟",
"school.revealAfterDue":"بعد موعد التسليم (موصى به)",
"school.revealNow":"فور تسليمه",
"school.revealNever":"لا تُعرض إطلاقاً",
...
"qr.title":"الدخول برمز QR",
"qr.sub":"امسح الرمز بكاميرا جوّالك، سجّل دخولك بحساب Google، ثم اكتب الرقم أدناه.",
"qr.pairLabel":"رقم المطابقة",
"qr.warnMatch":"لا توافق إلا على رقم تراه على هذه الشاشة نفسها.",
"qr.renew":"رمز جديد",
"qr.close":"إغلاق",
"qr.approveTitle":"فتح حسابك على شاشة الفصل",
"qr.approveSub":"هذه الموافقة تفتح حسابك على السبورة بصلاحية عرض فقط. حذف الملفات وإرسال الاختبارات وتعديل الجدول تبقى محتاجة دخولك بحساب Google على جهازك.",
"qr.approveGoogle":"الدخول بحساب Google",
"qr.approveCodeLabel":"الرقم المعروض على الشاشة",
"qr.approveBtn":"تأكيد الفتح",
...
"school.filesTitle":"الملفات",
"school.filesSub":"ارفع ملفاتك من أي جهاز، وستجدها هنا على السبورة بعد تسجيل دخولك.",
"school.fileTitle":"عنوان الملف","school.fileSubject":"المادة","school.fileGrade":"الصف",
"school.allGrades":"كل الصفوف",
"school.fileUpload":"اختر ملفاً (25 ميجا كحد أقصى)",
"school.fileOrLink":"أو الصق رابطاً بدل الرفع (مثل رابط كتاب من منصة عين)",
"school.fileShared":"يظهر لطلاب فصولي (أزل العلامة ليبقى خاصاً بي على السبورة)",
"school.fileAdd":"إضافة",
"school.linksTitle":"الروابط المباشرة",
"school.linksSub":"أي رابط: منصة، ملف PDF، عرض تقديمي… تفتحه بضغطة على السبورة. الحد 9 روابط.",
"school.linkLabel":"اسم الرابط","school.linkUrl":"العنوان","school.linkIcon":"أيقونة (اختياري)",
"school.linkShared":"يظهر لطلابي","school.linkAdd":"إضافة رابط",
"school.ttTitle":"الجدول الدراسي",
"school.ttSub":"اضغط أيقونة الملاحظة على أي يوم لتضيف تذكيراً أو تمييزاً خاصاً بك — لا يراه غيرك.",
...
"nav.schoolRecord":"السجلّ","school.recTitle":"السجلّ","school.recSub":"طلاب الفصل في المادة: واجباتهم واختباراتهم على المنصّة، ودرجاتهم الرسمية من نور كما هي.","school.recSubStudent":"أعمالك على المنصّة ودرجاتك الرسمية.","smsg.title":"رسائل البريد لطلاب المدرسة","smsg.sub":"رسالة تصل بريد طلاب مدرستكم وحدهم — الآن أو في موعد تختارونه.","smsg.subject":"العنوان","smsg.body":"نص الرسالة","smsg.when":"أرسلها تلقائياً في (اختياري)","smsg.whenHint":"اتركه فارغاً لترسلها بنفسك من القائمة أدناه. الموعد يُرسَل خلال ربع ساعة منه.","smsg.save":"احفظ الرسالة","smsg.rules":"٣ رسائل كحدّ أقصى في اليوم. نصّ عادي فقط، ويصل مع رابط يوقف به الطالب رسائل المدرسة.","og.title":"الدرجات الرسمية من نور","og.sub":"ارفع كشف درجات الفترة أو النهائي من نور. تُعرض كما هي تماماً — المنصّة لا تحسب درجة ولا معدّلاً.","og.idTitle":"أين يذهب رقم الهوية؟","og.idBody":"لا يُحفظ إطلاقاً. يُحوَّل في الخادم إلى بصمة الاستيراد نفسها، فتُطابَق بها، ثم يُرمى. ويُحفظ من الملف الأعمدة التي تختارها فقط، بعناوينها وقيمها كما هي.","og.file":"كشف الدرجات (‎.xlsx أو ‎.xls أو ‎.csv)",
...
"school.examFileConvert":"استخراج بالذكاء الاصطناعي",
"school.examTitle":"عنوان الاختبار","school.examSubject":"المادة","school.examGrade":"الصف",
"school.examClass":"الفصل الموجَّه له","school.examRaw":"الأسئلة — سطر لكل سؤال",
"school.examRawHint":"الشكل: نص السؤال | خيار | خيار | خيار | خيار | رقم الإجابة الصحيحة (يبدأ من ١)",
"school.examSave":"حفظ الاختبار",
"school.noteTitle":"ملاحظتي على هذا اليوم","school.noteDate":"التاريخ",
"school.noteAdd":"ملاحظة","school.noteRemind":"تذكير","school.noteMark":"تمييز اليوم",

"common.cancel":"إلغاء","common.ok":"تمام","common.refresh":"تحديث",
"school.requestAccount":"ليس لديك حساب؟ اطلب حساباً من المدرسة",
"school.requestAccountShort":"تقديم طلب حساب",
"school.signOut":"تسجيل الخروج",
"school.gateTitle":"حسابك غير مُفعَّل بعد",
"school.gateBody":"دخولك تم بنجاح، لكن هذا الحساب غير مُسجَّل ضمن أعضاء المدرسة. إن كنت قد قدّمت طلباً فهو بانتظار موافقة الإدارة.",
"school.reqTitle":"طلب حساب من المدرسة",
"school.reqSubtitle":"املأ بياناتك وسيصل الطلب لإدارة المدرسة مباشرة، وتُنشئ لك حساباً خاصاً بك.",
"school.reqName":"الاسم الكامل","school.reqRole":"أنت",
"school.roleStudent":"طالب","school.roleTeacher":"مدرّس",
"school.reqGrade":"الصف","school.reqSection":"الشعبة (اختياري)",
"school.grade1":"أول ثانوي","school.grade2":"ثاني ثانوي","school.grade3":"ثالث ثانوي",
"school.reqContact":"وسيلة تواصل (اختياري)","school.reqNote":"ملاحظة للإدارة (اختياري)",
"school.reqSend":"إرسال الطلب",
"school.reqDoneTitle":"وصل طلبك للإدارة",
"school.reqDoneBody":"ستراجعه الإدارة وتنشئ لك حساباً. عُد لتسجيل الدخول بعد إبلاغك بتفعيل الحساب.",
"school.adminTitle":"إدارة المدرسة",
"school.requestsTitle":"طلبات الحسابات","school.requestsSub":"طلبات وصلت من الموقع بانتظار قرارك.",
"school.membersTitle":"المدرّسون والطلاب",
...
"settings.modeLight":"فاتح","settings.calTitle":"التقويم","settings.calSub":"يُطبَّق على كل تاريخ في الموقع: رأس الصفحة، الجدول، مواعيد الاختبارات والواجبات","settings.calGregory":"ميلادي","settings.calHijri":"هجري","settings.modeDark":"داكن",
...
"filex.tab":"اشرح ملفي","filex.pick":"ارفع ملف مادتك","filex.formats":"ملف نصّي أو PDF نصّي (غير مصوَّر) — حتى 40 صفحة",
"filex.analyze":"افحص واشرح لي الملف","filex.safetyNote":"يُقبل المحتوى الدراسي الحقيقي فقط (مادة، ملزمة، محاضرة، بنك أسئلة). أي ملف خارج ذلك سيُرفض تلقائياً.",
"filex.askPh":"اسأل أي شيء عن ملفك…","filex.another":"ارفع ملفاً آخر",
...
"school.roleAdmin":"Admin","school.bulkMove":"Move","school.bulkAdd":"Also assign",
"school.bulkClear":"Clear selection","school.selectAll":"Select all shown students",
"school.classesTitle":"Classes",
"school.classesSub":"Create the school's classes first. Without them the timetable does not work, students cannot see their teachers' files, and teachers have no class to send an exam to.",
"school.classGrade":"Grade","school.classSection":"Section (required)",
"school.classNameOpt":"Class name (optional)","school.classAdd":"Add class",
"school.assignTitle":"Assign to a class","school.assignPick":"Class",
"school.assignSubject":"Subject (for teachers)","school.assignAdd":"Assign",
"school.assignCurrent":"Currently assigned","school.assignBtn":"Classes",
"school.reqNeedSignin":"Sign in with Google first",
"school.reqNeedSigninWhy":"We take your email straight from your account, so the approval reaches you with no typo.",
"school.reqEmail":"Your email (from your account — not editable)",
"school.reqEmailNote":"The administration creates your account on this email, so make sure it is the one you will use.",
"school.limitedBar":"Quick sign-in: viewing is available. Deleting, sending exams and editing the timetable need identity confirmation.",
"school.confirmGoogle":"Confirm with Google",
"school.quickTitle":"Quick sign-in on the board",
"school.quickSub":"Set a password on your own account so you can sign in quickly on the classroom board instead of typing your Google details every lesson.",
"school.quickWarnTitle":"What does this sign-in allow?",
"school.quickWarnBody":"Viewing only: files, links, timetable and exams. Deleting a file or link, sending an exam, or editing the timetable still require confirming with Google. The reason is that the password is typed on a screen the whole class can see.",
"school.quickPass":"New password",
"school.quickPass2":"Confirm it",
"school.quickSave":"Save password",
"school.examDuration":"Duration in minutes (optional)",
"school.examQuestions":"Questions",
"school.examAddQ":"Add question",
"school.examImport":"Quick import by pasting text",
"school.examImportBtn":"Add to draft",
"school.sendTitle":"Send exam",
"school.sendSub":"Pick classes, grade levels, or individual students. You can combine them.",
"school.sendClasses":"Classes","school.sendGrades":"Grades","school.sendStudents":"Students",
"school.sendNow":"Send",
"school.dueLabel":"Due date (optional)",
"school.dueHint":"Leave empty for homework with no deadline. Correct answers are revealed after this time.",
"school.revealLabel":"When can students see the correct answers?",
"school.revealAfterDue":"After the due date (recommended)",
"school.revealNow":"As soon as they submit",
"school.revealNever":"Never",
...
"qr.title":"Sign in with a QR code",
"qr.sub":"Scan the code with your phone camera, sign in with Google, then type the number below.",
"qr.pairLabel":"Matching number",
"qr.warnMatch":"Only approve a number you can see on this very screen.",
"qr.renew":"New code",
"qr.close":"Close",
"qr.approveTitle":"Open your account on the classroom screen",
"qr.approveSub":"This opens your account on the board with view-only access. Deleting files, sending exams and editing the timetable still require signing in with Google on your own device.",
"qr.approveGoogle":"Sign in with Google",
"qr.approveCodeLabel":"The number shown on the screen",
"qr.approveBtn":"Confirm",
...
"school.filesTitle":"Files",
"school.filesSub":"Upload from any device and find them here on the board after you sign in.",
"school.fileTitle":"File title","school.fileSubject":"Subject","school.fileGrade":"Grade",
"school.allGrades":"All grades",
"school.fileUpload":"Choose a file (25 MB max)",
"school.fileOrLink":"Or paste a link instead of uploading (e.g. a book on the Ien platform)",
"school.fileShared":"Visible to my classes (uncheck to keep it private to me on the board)",
"school.fileAdd":"Add",
"school.linksTitle":"Direct links",
"school.linksSub":"Any link: a platform, a PDF, a slide deck - one tap on the board. Limit: 9 links.",
"school.linkLabel":"Link name","school.linkUrl":"Address","school.linkIcon":"Icon (optional)",
"school.linkShared":"Visible to my students","school.linkAdd":"Add link",
"school.ttTitle":"Timetable",
"school.ttSub":"Tap the note icon on any day to add a private reminder or highlight - nobody else sees it.",
...
"nav.schoolRecord":"Record","school.recTitle":"Record","school.recSub":"Class students in the subject: their homework and exams on the platform, and official Noor grades as-is.","school.recSubStudent":"Your work on the platform and your official grades.","smsg.title":"Email messages to school students","smsg.sub":"A message that reaches your school's students only — now or at a time you choose.","smsg.subject":"Subject","smsg.body":"Message text","smsg.when":"Send automatically at (optional)","smsg.whenHint":"Leave empty to send it yourself from the list below. Scheduled messages go out within 15 minutes.","smsg.save":"Save message","smsg.rules":"Up to 3 messages a day. Plain text only; each comes with a link that lets the student stop school messages.","og.title":"Official grades from Noor","og.sub":"Upload a term or final grade sheet from Noor. Shown exactly as-is — the platform never computes grades or averages.","og.idTitle":"Where does the ID go?","og.idBody":"It is never stored. The server turns it into the same import fingerprint, matches, then discards it. Only the columns you pick are stored, with their headers and values as-is.","og.file":"Grade sheet (.xlsx, .xls or .csv)",
...
"school.examFileConvert":"Extract with AI",
"school.examTitle":"Exam title","school.examSubject":"Subject","school.examGrade":"Grade",
"school.examClass":"Target class","school.examRaw":"Questions - one per line",
"school.examRawHint":"Format: question | choice | choice | choice | choice | correct answer number (starts at 1)",
"school.examSave":"Save exam",
"school.noteTitle":"My note on this day","school.noteDate":"Date",
"school.noteAdd":"Note","school.noteRemind":"Reminder","school.noteMark":"Highlight day",

"common.cancel":"Cancel","common.ok":"Done","common.refresh":"Refresh",
"school.requestAccount":"No account? Request one from the school",
"school.requestAccountShort":"Request an account",
"school.signOut":"Sign out",
"school.gateTitle":"Your account is not active yet",
"school.gateBody":"You signed in successfully, but this account is not registered as a school member. If you already sent a request, it is awaiting the administration's approval.",
"school.reqTitle":"Request a school account",
"school.reqSubtitle":"Fill in your details and the request goes straight to the school administration, who will create your account.",
"school.reqName":"Full name","school.reqRole":"You are",
"school.roleStudent":"Student","school.roleTeacher":"Teacher",
"school.reqGrade":"Grade","school.reqSection":"Section (optional)",
"school.grade1":"Grade 10","school.grade2":"Grade 11","school.grade3":"Grade 12",
"school.reqContact":"Contact (optional)","school.reqNote":"Note to the administration (optional)",
"school.reqSend":"Send request",
"school.reqDoneTitle":"Your request reached the administration",
"school.reqDoneBody":"They will review it and create your account. Come back to sign in once you are told it is active.",
"school.adminTitle":"School administration",
"school.requestsTitle":"Account requests","school.requestsSub":"Requests received from the site awaiting your decision.",
"school.membersTitle":"Teachers and students",
...
"settings.modeLight":"Light","settings.calTitle":"Calendar","settings.calSub":"Applies to every date on the site: header, schedule, exam and homework dates","settings.calGregory":"Gregorian","settings.calHijri":"Hijri","settings.modeDark":"Dark",
...
"filex.tab":"Explain my file","filex.pick":"Upload your course file","filex.formats":"Text file or text-based PDF (not scanned) — up to 40 pages",
"filex.analyze":"Scan and explain my file","filex.safetyNote":"Only genuine study material is accepted (course notes, lectures, question banks). Anything else is rejected automatically.",
"filex.askPh":"Ask anything about your file…","filex.another":"Upload another file",
